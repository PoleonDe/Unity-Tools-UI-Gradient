    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f
            {
                ...
                float2 softMaskTexcoord : TEXCOORD2;
            ...
            v2f vert(appdata_t v)
            {
                ...
                OUT.softMaskTexcoord = mul(_ControlSoftMaskCanvasToMask, v.vertex).xy;
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                color.a *= lerp(1.0, softMaskAlpha, _ControlSoftMaskEnabled);
